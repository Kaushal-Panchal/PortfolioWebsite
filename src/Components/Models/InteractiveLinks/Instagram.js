...
export default function Model(props) {
  ...
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/Instagram.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group position={[0, 1.11, 0]} rotation={[Math.PI / 2, 0, 0]}>
        <mesh material={materials.Glow} geometry={nodes.Instagram_1.geometry} />
        <mesh material={materials.Body} geometry={nodes.Instagram_2.geometry} />
      </group>
    </group>
  )
}
