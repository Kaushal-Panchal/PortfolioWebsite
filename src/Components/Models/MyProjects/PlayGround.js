...
export default function Model(props) {
  ...
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/PlayGround.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      position={[0,-2.5,0]}
      lineHeight={1}
       > This is a web app created for school students, Which helps to manage their class chores like taking notes, dictionary etc... </Text>
...
useGLTF.preload('/PlayGround.glb')
